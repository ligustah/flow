...
fn draft_contains(
    ...
    match spec_type {
        CatalogType::Capture => draft
            .captures
            .get_by_key(&models::Capture::new(catalog_name))
            .is_some(),
        CatalogType::Collection => draft
            .collections
            .get_by_key(&models::Collection::new(catalog_name))
            .is_some(),
        CatalogType::Materialization => draft
            .materializations
            .get_by_key(&models::Materialization::new(catalog_name))
            .is_some(),
        CatalogType::Test => draft
            .tests
            .get_by_key(&models::Test::new(catalog_name))
            .is_some(),
    }
}
